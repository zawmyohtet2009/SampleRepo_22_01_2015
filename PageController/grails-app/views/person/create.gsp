		...
		<g:form action="save">
			<ol class="property-list person">
				<div 	class="fieldcontain ${hasErrors(bean: personInstance, field: 'name', 'error')} ">
					<label for="domain"> <g:message code="shop.domain.label"
							default="Name" />	
					</label>
					<g:textField name="name" value="${personInstance?.name}" />
				</div>
				<li class="fieldcontain"><label for="age">Age :</label> <g:textField
						name="age" /><br> <br></li>
				<li class="fieldcontain"><label for="Address"> Address:</label>
					<g:select name="address"
						from="${Person.constraints.address.inList }" /><br> <br>
				</li>
			</ol>
